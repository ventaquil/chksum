...
complete --command chksum-cli --short-option H --long-option hash --arguments 'MD5 SHA1 SHA-1 SHA224 SHA-224 SHA2 224 SHA-2 224 SHA256 SHA-256 SHA2 256 SHA-2 256' --exclusive --description 'Choose hashing algorithm'
