...
mod md5 {
    ...
    fn empty_string() -> Result {
        ...
        let mut string = String::from_utf8(data)?;
        let digest = string.chksum(HashAlgorithm::MD5)?;
...
mod sha1 {
    ...
    fn empty_string() -> Result {
        let data = data_with_size(Size::Empty as usize);
        let mut string = String::from_utf8(data)?;
        let digest = string.chksum(HashAlgorithm::SHA1)?;
        let digest = format!("{:X}", digest);
...
mod sha2 {
    ...
    mod sha224 {
        ...
        fn empty_string() -> Result {
            let data = data_with_size(Size::Empty as usize);
            let mut string = String::from_utf8(data)?;
            let digest = string.chksum(HashAlgorithm::SHA2_224)?;
            let digest = format!("{:X}", digest);
    ...
    mod sha256 {
        ...
        fn empty_string() -> Result {
            let data = data_with_size(Size::Empty as usize);
            let mut string = String::from_utf8(data)?;
            let digest = string.chksum(HashAlgorithm::SHA2_256)?;
            let digest = format!("{:X}", digest);
            assert_eq!(
                digest,
    ...
    mod sha384 {
        ...
        fn empty_string() -> Result {
            let data = data_with_size(Size::Empty as usize);
            let mut string = String::from_utf8(data)?;
            let digest = string.chksum(HashAlgorithm::SHA2_384)?;
            let digest = format!("{:X}", digest);
            assert_eq!(
                digest,
    ...
    mod sha512 {
        ...
        fn empty_string() -> Result {
            let data = data_with_size(Size::Empty as usize);
            let mut string = String::from_utf8(data)?;
            let digest = string.chksum(HashAlgorithm::SHA2_512)?;
            let digest = format!("{:X}", digest);
            assert_eq!(
                digest,
